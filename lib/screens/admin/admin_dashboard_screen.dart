        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                // TODO: Navigate to AdminOrdersScreen
              },
            ),
            ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                // TODO: Navigate to AdminCouponsScreen
              },
            ),
            const Divider(),
            ListTile(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                    child: _buildStatCard('Ventas', '\$12,450',
                        Icons.attach_money, AppColors.success)),
                const SizedBox(width: AppDimensions.paddingM),
                Expanded(
                    child: _buildStatCard('Pedidos', '24', Icons.shopping_bag,
                        AppColors.primary)),
              ],
            ),
            const SizedBox(height: AppDimensions.paddingM),
            Row(
              children: [
                Expanded(
                    child: _buildStatCard('Nuevos Usuarios', '8',
                        Icons.person_add, AppColors.loyaltyGold)),
                const SizedBox(width: AppDimensions.paddingM),
                Expanded(
                    child: _buildStatCard(
                        'Agotados', '3', Icons.warning, AppColors.error)),
              ],
            ),
            ...
            Wrap(
              ...
              children: [
                ...
                _buildActionButton(
                    'Escanear Pedido', Icons.qr_code_scanner, () {}),
              ],
            ),
          ],
        ),
